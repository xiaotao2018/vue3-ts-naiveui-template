 ...
 * @LastEditTime: 2022-11-24 13:52:12
-->
<template>
  ...
  <n-button type="tertiary" :tertiary="true" :round="true" :disabled="false" @click="openPage">naive-ui跳转新页面</n-button>
...
onBeforeMount(() => {
  ...
  // getPubPageBasicData('7105991819599544333')
  //   .then((res) => {
  //     console.log('res', res)
  //   })
  //   .catch((err) => {
